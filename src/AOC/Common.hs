...
parseOrFail :: (P.ShowErrorComponent e, P.TraversableStream s, P.VisualStream s) => P.Parsec e s a -> s -> a
...
pairwiseM :: Monad m => (a -> a -> m b) -> [a] -> m [b]
pairwiseM f = sequence . pairwise f
